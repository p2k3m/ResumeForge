...
export async function render2025Template({
  ...
  const educationEntries = extractEntries(sectionMap.get('education'), entryOptions);
  const projectEntries = extractEntries(sectionMap.get('projects'), entryOptions);
  const skillsEntries = extractEntries(sectionMap.get('skills'), entryOptions);
  const languageEntries = extractEntries(sectionMap.get('languages'), entryOptions);
  const contactEntries = extractEntries(sectionMap.get('contact'), entryOptions);
