...
/**
 * Determine which job skills are absent from the resume skill inventory. This
 * helper feeds downstream enhancement flows and is shared across microservices
 * so that "skill gap" telemetry remains consistent in Lambda handlers and
 * Express routes.
 */
export function computeSkillGap(jobSkills = [], resumeSkills = []) {
