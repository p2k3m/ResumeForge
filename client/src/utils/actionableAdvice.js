...
export function normaliseActionList(items) {
...
export function inferActionType(source, fallback = 'general') {
...
export function buildActionableMessage(type, payload = {}) {
  switch (type) {
    case 'skills':
...
export function buildCategoryAdvice(categoryKey, bucket = {}) {
...
export function buildSegmentAdvice(label, segment = {}) {
...
export function buildImprovementHintFromSegment(segment) {
...
export function buildMetricTip(metric = {}, context = {}) {
