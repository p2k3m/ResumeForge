export const COVER_TEMPLATE_STYLE_MAP = {
  cover_modern: {
...
export const DEFAULT_COVER_TEMPLATE_STYLE = {
  header: 'bg-gradient-to-r from-slate-700 via-slate-600 to-slate-500 text-white',
...
export const getCoverTemplateStyle = (templateId) => {
...
export default getCoverTemplateStyle
