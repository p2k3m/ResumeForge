...
describe('published CloudFront helpers', () => {
    ...
    try {
      ...
      expect(response.body).toEqual({
        ...
        cloudfront: {
          ...
          url: 'https://d3p9a7w5x4y2z.cloudfront.net',
          fileUrl: 'https://d3p9a7w5x4y2z.cloudfront.net',
          typeUrl: 'https://d3p9a7w5x4y2z.cloudfront.net#download',
  ...
  test('redirects callers to the published domain', async () => {
    const metadata = {
      stackName: 'ResumeForge',
      url: 'https://d3p9a7w5x4y2z.cloudfront.net/prod',
      distributionId: 'E3NEWCFDN0001',
      updatedAt: '2024-12-12T14:45:00.000Z',
      originBucket: 'resume-forge-app-2025',
      originRegion: 'ap-south-1',
    ...
    try {
      ...
      expect(response.headers.location).toBe('https://d3p9a7w5x4y2z.cloudfront.net/prod');
    } finally {
      await cleanup();
    }
  });
  ...
  test('allows redirecting to a specific path on the published domain', async () => {
    ...
    try {
      ...
      expect(response.headers.location).toBe(
        'https://d3p9a7w5x4y2z.cloudfront.net/api/process-cv'
      );
    } finally {
      await cleanup();
    }
